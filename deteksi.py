...
GPIO.setup(16, GPIO.OUT)    # set motor
...
pwm_4a = GPIO.PWM(20, 100)
pwm_4b = GPIO.PWM(16, 100)
...
def to_left():
    pwm_1a.ChangeDutyCycle(100)
    pwm_1b.ChangeDutyCycle(0)
    pwm_2a.ChangeDutyCycle(0)
    pwm_2b.ChangeDutyCycle(100)
    pwm_3a.ChangeDutyCycle(100)
    pwm_3b.ChangeDutyCycle(0)
    pwm_4a.ChangeDutyCycle(0)
    pwm_4b.ChangeDutyCycle(0)
...
def to_right():
    pwm_1a.ChangeDutyCycle(0)
    pwm_1b.ChangeDutyCycle(100)
    pwm_2a.ChangeDutyCycle(100)
    pwm_2b.ChangeDutyCycle(0)
    pwm_3a.ChangeDutyCycle(0)
    pwm_3b.ChangeDutyCycle(100)
    pwm_4a.ChangeDutyCycle(0)
    pwm_4b.ChangeDutyCycle(0)
