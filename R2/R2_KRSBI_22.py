...
GPIO.setup(4, GPIO.OUT)    # set motor
...
def maju_maju_motor():
    pwm_1a.ChangeDutyCycle(0)
    pwm_1b.ChangeDutyCycle(40)
    pwm_2a.ChangeDutyCycle(0)
    pwm_2b.ChangeDutyCycle(0)
    pwm_3a.ChangeDutyCycle(40)
    pwm_3b.ChangeDutyCycle(0)
...
def putar_kanan_awal():
    ...
    pwm_2a.ChangeDutyCycle(12)
    pwm_2b.ChangeDutyCycle(0)
    pwm_3a.ChangeDutyCycle(0)
    pwm_3b.ChangeDutyCycle(12)
...
def kiri():
    ...
    pwm_2a.ChangeDutyCycle(30)
    pwm_2b.ChangeDutyCycle(0)
    pwm_3a.ChangeDutyCycle(30)
    pwm_3b.ChangeDutyCycle(0)

def Gerak2():
    pwm_1a.ChangeDutyCycle(0)
    pwm_1b.ChangeDutyCycle(14)
    pwm_2a.ChangeDutyCycle(14)
    pwm_2b.ChangeDutyCycle(0)
    pwm_3a.ChangeDutyCycle(0)
    pwm_3b.ChangeDutyCycle(14)
    
def Gerak3():
    pwm_1a.ChangeDutyCycle(0)
    pwm_1b.ChangeDutyCycle(35)
    pwm_2a.ChangeDutyCycle(0)
    pwm_2b.ChangeDutyCycle(35)
    pwm_3a.ChangeDutyCycle(11)
    pwm_3b.ChangeDutyCycle(0)

def Gerak_ke_gawang_kick_off_kanan():
    putar_kanan_awal()
    time.sleep(2.2)
    maju_maju_motor()
    time.sleep(4)
...
def kirim_terima_pesan():
    ...
    serverAddressPort   = ("192.168.43.119", 20001)
